...
- **Plan:** `docs/l3_plan.md` (approved; decisions `D-L3-1`…`D-L3-7`).
- **Status:** milestones 1–3 **done and green** (LLM-free). A general CSP IR +
...
| L4 | GSM8K | dev/eval + gold committed | numeric match | implemented; synthetic 37/37, gold 8/8; live dev 12/12, eval 38/40, 0 grounded |
